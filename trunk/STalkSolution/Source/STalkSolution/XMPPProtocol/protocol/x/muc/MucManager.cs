...
using XMPPProtocol.Protocol.x.muc;
using XMPPProtocol.Protocol.x.muc.iq;
using XMPPProtocol.Protocol.x.muc.iq.admin;
using XMPPProtocol.Protocol.x.muc.iq.owner;
...
namespace XMPPProtocol.Protocol.x.muc
{
    ...
    public class MucManager
    {
        ...
        */
        ...
        {
            OwnerIq oIq = new XMPPProtocol.Protocol.x.muc.iq.owner.OwnerIq(IqType.get, room);          
        ...
        */
        ...
        public void RequestList(Affiliation affiliation, Jid room, IqCB cb, object cbArg)
        {
            ...
            aIq.Query.AddItem(new XMPPProtocol.Protocol.x.muc.iq.admin.Item(affiliation));
        ...
        public void RequestList(Role role, Jid room, IqCB cb, object cbArg)
        {
            ...
            aIq.Query.AddItem(new XMPPProtocol.Protocol.x.muc.iq.admin.Item(role));
        ...
        public void ModifyList(Jid room, XMPPProtocol.Protocol.x.muc.iq.admin.Item[] items)
        {
        ...
        private void ChangeRole(Role role, Jid room, string nickname, string reason, IqCB cb, object cbArg)
        {
            ...
            XMPPProtocol.Protocol.x.muc.iq.admin.Item itm = new XMPPProtocol.Protocol.x.muc.iq.admin.Item();
            itm.Role = role;
