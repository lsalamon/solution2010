...
using XMPPProtocol.Protocol.iq.register;
using XMPPProtocol.Protocol.iq.version;
using XMPPProtocol.Protocol.stream;
using XMPPProtocol.Protocol.stream.feature.compression;
using XMPPProtocol.Protocol.client;
using XMPPProtocol.Protocol.tls;
using XMPPProtocol.Protocol.extensions.caps;
using XMPPProtocol.Protocol.extensions.compression;
using XMPPProtocol.exceptions;
using XMPPProtocol.Sasl;
using XMPPProtocol.net;
using XMPPProtocol.net.dns;
using XMPPProtocol.Idn;
...
namespace XMPPProtocol
{
	...
	{       
		...
		private		string					m_Resource			= "XMPPProtocol";		
        ...
        /// </summary>
        /// <seealso cref="XMPPProtocol.Protocol.Base.XmppPacket.Language"/>
		...
		*/
		...
		public override void StreamParserOnStreamElement(object sender, Node e)
		{
            ...
            else if (e.GetType() == typeof(XMPPProtocol.Protocol.stream.Features))
			{
				// Stream Features
				// StartTLS stuff
                XMPPProtocol.Protocol.stream.Features f = e as XMPPProtocol.Protocol.stream.Features;
                if (m_UseCompression &&
            ...
            else if (e is XMPPProtocol.Protocol.Error)
            {
