...
using XMPPProtocol.Protocol.extensions.bosh;
...
namespace XMPPProtocol
{
	...
	{	
		...
		public XmppConnection(XMPPProtocol.net.SocketConnectionType type) : this()
		{
		...
		private void InitSocket()
		{
			...
			// Socket Stuff
			if (m_SocketConnectionType == XMPPProtocol.net.SocketConnectionType.HttpPolling)
				m_ClientSocket= new PollClientSocket();            
            else if (m_SocketConnectionType == XMPPProtocol.net.SocketConnectionType.Bosh)
